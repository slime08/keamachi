  ...
  const fetchFacilities = async () => {
    try {
      ...
      const mockData: Facility[] = [
        { id: 1, name: 'サンシャイン福祉センター', description: '訪問介護サービスを提供', location: '東京都渋谷区', service_type: '訪問介護', rating: 4.8, reviews: 24, imageUrl: '/keamachi/1.png', availability: { mon: 'open', tue: 'open', wed: 'open', thu: 'open', fri: 'open', sat: 'closed', sun: 'closed' } },
        { id: 2, name: 'ケアホーム山田', description: 'グループホーム', location: '東京都新宿区', service_type: 'グループホーム', rating: 4.6, reviews: 18, imageUrl: '/keamachi/2.png', availability: { mon: 'closed', tue: 'limited', wed: 'open', thu: 'open', fri: 'open', sat: 'limited', sun: 'closed' } },
        { id: 3, name: 'デイサービス太陽', description: 'デイサービス', location: '東京都渋谷区', service_type: 'デイサービス', rating: 4.9, reviews: 32, imageUrl: '/keamachi/3.png', availability: { mon: 'open', tue: 'limited', wed: 'open', thu: 'closed', fri: 'open', sat: 'closed', sun: 'closed' } },
        { id: 4, name: '介護老健施設 希望', description: '老健施設', location: '神奈川県横浜市', service_type: '老健施設', rating: 4.5, reviews: 15, imageUrl: '/keamachi/4.png', availability: { mon: 'open', tue: 'closed', wed: 'open', thu: 'limited', fri: 'open', sat: 'open', sun: 'closed' } },
        { id: 5, name: '障害者支援センター ライト', description: '障害福祉', location: '埼玉県さいたま市', service_type: '障害福祉', rating: 4.7, reviews: 12, imageUrl: '/keamachi/5.png', availability: { mon: 'open', tue: 'open', wed: 'limited', thu: 'open', fri: 'limited', sat: 'closed', sun: 'closed' } },
        { id: 6, name: '児童発達支援 キッズホーム', description: '児童福祉', location: '千葉県船橋市', service_type: '児童福祉', rating: 4.8, reviews: 20, imageUrl: '/keamachi/6.png', availability: { mon: 'closed', tue: 'closed', wed: 'open', thu: 'open', fri: 'open', sat: 'closed', sun: 'closed' } },
        { id: 7, name: 'ナイトケアつばさ', description: '夜間訪問介護', location: '東京都港区', service_type: '訪問介護', rating: 4.2, reviews: 8, imageUrl: '/keamachi/7.png', availability: { mon: 'limited', tue: 'open', wed: 'limited', thu: 'open', fri: 'limited', sat: 'closed', sun: 'closed' } },
        { id: 8, name: 'ひかりデイセンター', description: '地域密着型デイサービス', location: '神奈川県川崎市', service_type: 'デイサービス', rating: 4.4, reviews: 10, imageUrl: '/keamachi/8.png', availability: { mon: 'open', tue: 'open', wed: 'open', thu: 'open', fri: 'limited', sat: 'closed', sun: 'closed' } },
        { id: 9, name: 'サンデーケア虹', description: '週末ケア', location: '千葉県千葉市', service_type: 'グループホーム', rating: 4.3, reviews: 6, imageUrl: '/keamachi/gazo1.png', availability: { mon: 'closed', tue: 'closed', wed: 'limited', thu: 'open', fri: 'open', sat: 'limited', sun: 'open' } },
        { id: 10, name: 'みどり在宅ケアステーション', description: '在宅トータルサポート', location: '東京都世田谷区', service_type: '訪問介護', rating: 4.7, reviews: 14, imageUrl: '/keamachi/gazo1.png', availability: { mon: 'open', tue: 'open', wed: 'open', thu: 'open', fri: 'open', sat: 'closed', sun: 'closed' } }
      ]
